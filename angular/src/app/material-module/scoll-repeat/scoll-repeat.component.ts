...
@Component({
  selector: 'app-scoll-repeat',
  templateUrl: './scoll-repeat.component.html',
  styleUrls: ['./scoll-repeat.component.scss']
})
export class ScollRepeatComponent implements OnInit, OnChanges {
